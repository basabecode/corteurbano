        ...
        {!profileLoading && !userId && !bookingSuccess ? (
          <div className="space-y-5 py-2">
            <div className="text-center space-y-2">
              ...
              <h3 className="font-semibold text-slate-100 text-lg">Necesitas una cuenta</h3>
              <p className="text-sm text-slate-400 max-w-xs mx-auto">
                Para completar tu reserva, inicia sesión o crea una cuenta gratuita como cliente.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-slate-900 px-3 text-slate-500">o con email</span>
              </div>
            </div>
